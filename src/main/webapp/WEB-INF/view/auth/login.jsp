                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <img src="/img/login.svg" alt="login" class="h-100">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="post" action="/login" class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" id="inputEmail" placeholder="Enter Email Address..." name="username"/>
                                        </div>
                                        <div class="form-group">
